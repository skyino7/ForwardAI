      ...
      <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
          <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
              ...
              <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                  ...
                  <li>
                      <a href="#" onClick={() => setDashboardOpen(!dashboardOpen)} className="nav-link px-0 align-middle">
                  ...
                  <li>
                      <a href="#" onClick={() => setBootstrapOpen(!bootstrapOpen)} aria-expanded={bootstrapOpen} className="nav-link px-0 align-middle ">
                  ...
                  <li>
                      <a href="#" onClick={() => setProductsOpen(!productsOpen)} className="nav-link px-0 align-middle">
